...
import { 
  ...
  Sparkles, Leaf, FlaskConical, AlertCircle, CheckCircle2, Shield, ArrowLeft
} from 'lucide-react';
...
export default function LoginPage({ onNavigateHome, onLoginSuccess, onNavigateAdmin }) {
  ...
  // Handle Admin Portal Verification
  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] bg-gradient-to-br from-[#F5F8FC] via-[#EEF4FB] to-[#E5EFF8] flex items-center justify-center p-4 sm:p-6 lg:p-12 relative overflow-hidden">
      ...
      <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-6 sm:space-y-8 text-left">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm sm:text-base text-slate-600 max-w-md font-normal leading-relaxed">
              {isAdminLogin
                ? 'Secure administrative portal for store metrics, live order fulfillment, inventory, and customer management.'
                : isSignUp 
        ...
        {/* =========================================================================
            RIGHT COLUMN: THE LOGIN / ADMIN / SIGNUP CARD
           ========================================================================= */}
        <div className="lg:col-span-6 flex justify-center lg:justify-end">
          <div className="w-full max-w-md bg-white rounded-[2rem] sm:rounded-[2.5rem] shadow-xl border border-slate-100 p-6 sm:p-10 space-y-6">
            ...
            {isAdminLogin ? (
              <div className="space-y-6">
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className="text-xs text-slate-500">
                    Enter your authorized Admin ID and Password
                  </p>
                </div>
                ...
                <form onSubmit={handleAdminSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5 text-left">
                    <label className="text-xs font-semibold text-slate-700 block">Admin ID</label>
                    <div className="relative">
                  ...
                  <div className="space-y-1.5 text-left">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-11 py-3 text-xs sm:text-sm bg-white border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:border-slate-900 focus:ring-2 focus:ring-slate-900/10 transition-all"
                      />
                      <button
                        type="button"
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm rounded-xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer mt-2"
                  >
              ...
              /* =====================================================================
                  VIEW B: CUSTOMER LOGIN / SIGNUP / FORGOT PASSWORD
                 ===================================================================== */
              <>
                {/* Form Header */}
                ...
                <div className="pt-3 border-t border-slate-100/90 text-center">
                  ...
                  >
                    <Shield className="w-3 h-3 text-glow-orange" />
